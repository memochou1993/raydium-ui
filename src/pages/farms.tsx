...
function FarmHeader() {
  ...
  return isMobile ? (
    <Row className="flex-wrap items-center justify-center px-2 py-1 mb-2">
      {/* <div className="-mb-1 text-lg font-semibold text-white justify-self-start">Farms</div> */}
    ...
    <Col>
      <Grid className="items-center justify-between grid-cols-3 pt-0 pb-8">
        <div className="text-2xl font-semibold text-white justify-self-start">Farms</div>
        <FarmTabBlock />
        <FarmStakedOnlyBlock />
      </Grid>
    </Col>
      ...
      <Popover placement="bottom-right">
        ...
        <Popover.Panel>
          <div>
            ...
            >
              <Grid className="items-center grid-cols-1 gap-2">
                <FarmStakedOnlyBlock />
...
function FarmStakedOnlyBlock({ className }: { className?: string }) {
  ...
  return (
    <Row className="flex-wrap items-center justify-self-end mobile:justify-self-auto">
...
function FarmCard() {
  ...
  const innerFarmDatabaseWidgets = isMobile ? (
    ...
    <Row className="flex-wrap items-center justify-between gap-8 mb-4">
      <div>
        <div className="text-lg font-medium text-white">All Farms</div>
  ...
  return (
    <CyberpunkStyleCard
      ...
      className="flex flex-col w-full h-full p-10 pt-6 pb-4 mobile:px-3 mobile:py-3"
      size="lg"
      style={{
        background:
          'linear-gradient(140.14deg, rgba(0, 182, 191, 0.15) 0%, rgba(27, 22, 89, 0.1) 86.61%), linear-gradient(321.82deg, #18134D 0%, #1B1659 100%)'
    ...
    >
      ...
      {!isMobile && (
        ...
        >
          ...
          <FarmRefreshCircleBlock className="self-center pr-8" />
        </Row>
      )}
...
function FarmCardDatabaseBodyCollapseItemFace({
  ...
  const pcCotent = (
    ...
    >
      <div className="self-center w-12 ml-6 mr-2">
        {isFavourite ? (
          <Icon
            ...
            className="self-center m-auto clickable clickable-mask-offset-2"
          />
        ) : (
          <Icon
            ...
            className="self-center m-auto transition clickable clickable-mask-offset-2 opacity-30 hover:opacity-80"
          />
        )}
      </div>
      ...
      <Grid className="self-center mr-8 w-9 h-9 place-items-center">
      ...
      <Collapse.Face>
        ...
        >
          <div className="self-center w-8 ">
            {isFavourite ? (
              <Icon
                className="self-center m-auto clickable"
                iconSrc="/icons/misc-star-filled.svg"
                onClick={({ ev }) => {
                  ev.stopPropagation()
                  onUnFavorite?.(toPubString(info.id))
              ...
              <Icon
                className="self-center m-auto transition clickable opacity-30 hover:opacity-80 clickable-mask-offset-2"
                iconSrc="/icons/misc-star-empty.svg"
                onClick={({ ev }) => {
                  ev.stopPropagation()
                  onStartFavorite?.(toPubString(info.id))
          ...
          <Grid className="self-center w-6 h-6 place-items-center">
...
function FarmCardDatabaseBodyCollapseItemContent({ hydratedInfo }: { hydratedInfo: HydratedFarmInfo }) {
  ...
  return (
    ...
    >
      <AutoBox is={isMobile ? 'Col' : 'Row'} className="flex-grow gap-8 px-8 py-5 mobile:gap-3 mobile:px-4 mobile:py-3">
        <Row className="p-6 mobile:py-3 mobile:px-4 flex-grow ring-inset ring-1.5 mobile:ring-1 ring-[rgba(171,196,255,.5)] rounded-3xl mobile:rounded-xl items-center gap-3">
          <div className="flex-grow">
            ...
            <div className="text-base font-medium text-white mobile:text-xs">
...
function CoinAvatarInfoItem({ info, className }: { info: HydratedFarmInfo | FarmPoolJsonInfo; className?: string }) {
  ...
  if (isFarmJsonInfo(info)) {
    ...
    return (
      ...
      >
        {
          <CoinAvatarPair
            className="mr-2 justify-self-center"
            size={isMobile ? 'sm' : 'md'}
            token1={lpToken?.base}
  ...
  return (
    ...
    >
      <CoinAvatarPair className="mr-2 justify-self-center" size={isMobile ? 'sm' : 'md'} token1={base} token2={quote} />
      <div className="mobile:text-xs font-medium mobile:mt-px mr-1.5">{name}</div>
...
function TextInfoItem({
  ...
  return (
    <Col className={twMerge('w-max', className)}>
      ...
      <Col className="justify-center flex-grow">
