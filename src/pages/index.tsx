...
function HomePageSection0() {
  ...
  return (
    <section className="relative mb-16 grid-child-center grid-cover-container">
      ...
      <div className="grid-cover-content children-center">
        ...
        {/* two button */}
        <Row className="grid gap-8 mb-16 mobile:gap-4 mobile:mb-6 grid-cols-2-fr">
          <Button
            className="px-5 text-white home-rainbow-button-bg mobile:text-xs mobile:px-4"
            onClick={() => {
              push('/swap')
            }}
          >
          ...
          <Button
            className="px-5 text-white frosted-glass-teal mobile:text-xs mobile:px-4 forsted-blur"
            onClick={() => {
        ...
        {/* two panels */}
        <Row className="grid gap-6 mobile:gap-3 mb-9 grid-cols-2-fr">
          <Card className="frosted-glass-smoke forsted-blur-sm rounded-3xl mobile:rounded-2xl p-6 mobile:py-3 mobile:px-6 mobile:min-w-[156px] min-w-[250px] tablet:min-w-[250px]">
            ...
            {/* value */}
            <Row className="justify-center text-xl font-normal tracking-widest text-white mobile:text-xs mobile:tracking-wider">
  ...
  return (
    ...
    >
      ...
      <div>
        <div className="mb-8">
          <div
            className="w-10 h-px mx-auto my-2 rounded-full"
        ...
        <Grid className="grid-cols-4 gap-5 tablet:grid-cols-2 mobile:grid-cols-1">
          <Card className="flex-1 px-12 py-6 children-center frosted-glass-lightsmoke forsted-blur-sm rounded-3xl">
            <div className="p-3 mb-3 frosted-glass-teal rounded-xl">
              <Icon iconSrc="/icons/home-trade.svg" />
            </div>
            <div className="mb-2 text-lg font-semibold text-white">Trade</div>
          ...
          <Card className="flex-1 px-12 py-6 children-center frosted-glass-lightsmoke forsted-blur-sm rounded-3xl">
            ...
            <div className="mb-2 text-lg font-semibold text-white">Yield</div>
          ...
          <Card className="flex-1 px-12 py-6 children-center frosted-glass-lightsmoke forsted-blur-sm rounded-3xl">
            ...
            <div className="mb-2 text-lg font-semibold text-white">Pool</div>
          ...
          <Card className="flex-1 px-12 py-6 children-center frosted-glass-lightsmoke forsted-blur-sm rounded-3xl">
            ...
            <div className="mb-2 text-lg font-semibold text-white">AcceleRaytor</div>
  ...
  return (
    <section className="grid-child-center grid-cover-container">
      ...
      <div className="max-w-[1220px] px-14 tablet:px-4 mt-28 mx-16 tablet:mx-4 mb-44">
        ...
        <Grid className="grid-cols-3 gap-6 tablet:grid-cols-1 mobile:grid-cols-1 justify-items-center">
          <Card
          ...
          >
            ...
            <div className="mb-2 text-lg font-semibold text-white">Order Book AMM</div>
          ...
          >
            ...
            <div className="mb-2 text-lg font-semibold text-white">Best Price Swaps</div>
            <div className="font-light text-[#c4d6ff] mb-5">
          ...
          >
            ...
            <div className="mb-2 text-lg font-semibold text-white">High-Liquidity Launches</div>
            <div className="font-light text-[#c4d6ff] mb-5">
...
function HomePageSection3() {
  return (
    <section className="mb-24 children-center">
      <div className="mb-8">
      ...
      <Row className="justify-around w-full gap-16 px-56 tablet:px-0 mobile:px-0 tablet:grid mobile:grid">
  ...
  return (
    ...
    >
      <Grid className="mobile:gap-14 justify-around px-[10%] grid-cols-4 tablet:grid-cols-3 mobile:grid-cols-1 gap-16">
        <div>
          <div className="mb-8">
            <div className="mb-3 text-sm tablet:text-center">ABOUT</div>
            <div
        ...
        <div>
          <div className="mb-8">
            <div className="mb-3 text-sm tablet:text-center">PROTOCOL</div>
            <div
              className="w-6 h-px my-2 rounded-full tablet:mx-auto"
              style={{ background: 'radial-gradient(39.84% 47.5% at 96.82% 58.33%, #39d0d8 0%, #2b6aff 100%)' }}
            />
        ...
        <div>
          <div className="mb-8">
            <div className="mb-3 text-sm tablet:text-center">SUPPORT</div>
            <div
              className="w-6 h-px my-2 rounded-full tablet:mx-auto"
              style={{ background: 'radial-gradient(39.84% 47.5% at 96.82% 58.33%, #39d0d8 0%, #2b6aff 100%)' }}
            />
        ...
        <div className="tablet:col-span-full tablet:justify-self-center">
          <div className="mb-8 tablet:hidden">
            <div className="mb-3 text-sm">COMMUNITY</div>
            <div
              className="w-6 h-px my-2 rounded-full"
              style={{ background: 'radial-gradient(39.84% 47.5% at 96.82% 58.33%, #39d0d8 0%, #2b6aff 100%)' }}
            />
          </div>
          <Grid className="flex flex-col gap-6 tablet:flex-row tablet:gap-10">
      ...
      <Image className="p-20 mx-auto transform scale-125 pointer-events-none" src="/logo/logo-with-text.svg" />
    </footer>
  )
}
