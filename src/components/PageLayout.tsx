    ...
    >
      ...
      {isMobile ? (
        <>
          ...
          >
            {({ close }) => <SideMenu className="h-screen flex-container" onClickCloseBtn={close} />}
          </Drawer>
        </>
      ) : (
        <>
...
function MigrateBubble() {
  ...
  return (
    <Grid className="pc:grid-cols-[auto,1fr,auto] mobile:grid-cols-[auto,1fr] gap-3 justify-between items-center py-6 px-8 mb-10 rounded-xl ring-1.5 ring-inset ring-[#DA2EEF] bg-[#1B1659]">
      ...
      <Col className="gap-2">
        <div className="text-base font-medium text-white">You have old tokenAccount </div>
        <div className="text-[#C4D6FF] text-sm font-medium">
      ...
      <Row className="gap-8">
        <Button
          className="w-40 mobile:flex-grow frosted-glass-teal"
...
function Navbar({
  ...
  const mobileNavContent = (
    <Grid className="items-center grid-cols-3">
    ...
    <>
      ...
      >
        ...
        <Col className="grid-cols-[auto,5fr,auto,1fr] justify-between flex-1 overflow-hidden">
          <div className="px-2 py-4 mx-2 mb-2 space-y-1 overflow-y-auto shrink mobile:py-0">
            ...
            <LinkItem icon="/icons/entry-icon-liquidity.svg" href="/zap" isCurrentRoutePath={pathname.includes('zap')}>
              Zap
            </LinkItem>
...
function SettingPopover() {
  ...
  return (
    <div className="px-6 py-5">
      <Row className="items-center gap-2 mb-3 mobile:mb-6">
  ...
  return (
    <div className="block py-4 mobile:py-3 px-8 mobile:px-5 hover:bg-[rgba(57,208,216,0.1)] active:bg-[rgba(41,157,163,0.3)] cursor-pointer group">
      <Row className="items-center w-full mobile:justify-center">
        <div className="grid w-4 h-4 mr-3 mobile:w-3 mobile:h-3 place-items-center ">
          {isLoading ? (
              ...
              <Row className="items-center w-full">
                ...
                >
                  ...
                  {endPoint.isUserCustomized && !isCurrentEndPoint && (
                    <Icon
                      className="ml-auto text-red-600 transition opacity-0 justify-self-end clickable group-hover:opacity-100"
                      iconClassName="ml-6"
                      heroIconName="trash"
                      onClick={({ ev }) => {
